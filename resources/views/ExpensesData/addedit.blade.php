...
<article id="accounting" class="DEC_flex_wrapper " data-category="accounting accounting_sub_6">
		...
		<fieldset>
			...
			<div class="col-xs-12 mt5">
				...
				<div class="col-xs-9">
					{{ Form::select('content',[null=>'']+$contentDetail,(isset($expensesDataEdit[0]->content)) ? $expensesDataEdit[0]->content : '',
							array('name' =>'expensesDataContent',
									'id'=>'expensesDataContent',
									'onkeyup'=>'disabledemp();',
