...
<!-- article to select the main&sub menu -->
		...
		@endif
			...
			@endif
				...
				<div class="alinkEng ml20 mt5 tal">
					<a class="pageload csrp btn-link" href="{{ url('ExpensesData/index?mainmenu=ExpensesData&time='.date('Ymdhis')) }}" style="color:blue;font-size: 13px;">
			...
			<div class="col-xs-3" style="padding-left: 53px;">
				...
				<div class="alinkEng ml20 mt5 tal">
					<a class="pageload csrp btn-link" href="{{ url('ExternalInvoice/index?mainmenu=AuditingExtInvoice&time='.date('Ymdhis')) }}" style="color:blue;font-size: 13px;">
						{{ trans('messages.lbl_extInvoice') }}
					</a>
				</div>
				<div class="alinkEng ml20 mt5 tal">
				...
				<div class="alinkEng ml20 mt5 tal">
				<a class="pageload csrp btn-link" href="{{ url('Accounting/index?mainmenu=AuditingAccounting&time='.date('Ymdhis')) }}" style="color:blue;font-size: 13px;">
						{{ trans('messages.lbl_accounting') }}
					</a>
				</div>
				<div class="alinkEng ml20 mt5 tal">
				...
				<div class="alinkEng ml20 mt5 tal">
					<a class="pageload csrp btn-link" href="{{ url('AccBankPassbookDtls/index?mainmenu=AuditingBankPassbook&time='.date('Ymdhis')) }}" style="color:blue;font-size: 13px;">
						{{ trans('messages.lbl_passbookdetail') }}
					</a>
				</div>
			</div>
