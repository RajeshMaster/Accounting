...
{{ HTML::script('resources/assets/js/audpayment.js') }}

<div class="CMN_display_block" id="main_contents">

<!-- article to select the main&sub menu -->

<article id="auditing" class="DEC_flex_wrapper " data-category="auditing auditing_sub_4">
	{{ Form::open(array('name'=>'frmaudpaymentindex', 
						'id'=>'frmaudpaymentindex', 
						'url' => 'AudPayment/index?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),
						'files'=>true,
						'method' => 'POST')) }}
