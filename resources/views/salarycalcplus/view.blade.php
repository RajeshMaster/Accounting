			...
			<div class="col-xs-12 pt5">
				...
				<!-- Session msg -->
					<div class="col-xs-6" style="text-align: left;margin-left: -15px;">
						<a href="javascript:gotoindexsalarycalc('{{ $request->mainmenu }}');" 
							class="btn btn-info box80">
							<span class="fa fa-arrow-left"></span>
							{{ trans('messages.lbl_back') }}
						</a>
						<a href="javascript:fngodownloadempid('{{ $request->mainmenu }}');" 
							class=" btn btn-primary box120"><span class="fa fa-download"></span> 
