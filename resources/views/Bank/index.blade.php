...
<article id="setting" class="DEC_flex_wrapper " data-category="setting setting_sub_4">
	 				...
	 				@for ($i = 0; $i < count($empdetails); $i++)
						...
						<tr>
							...
							<td class="tac vam">
								...
								<a style ="color:blue;" href = "javascript:changeFlg('{{ $empdetails[$i]['id'] }}','{{ $empdetails[$i]['Location'] }}','{{ $empdetails[$i]['delflg'] }}')">
									{{ trans('messages.lbl_notuse') }}
								</a>

								@else

									<a style ="color:red;" href = "javascript:changeFlg('{{ $empdetails[$i]['id'] }}','{{ $empdetails[$i]['Location'] }}','{{ $empdetails[$i]['delflg'] }}')">
