...
Route::group(['prefix'=>'CreditCardPay','middleware' => 'auth'], function() {
    ...
    Route::any('yearindex', 'CreditCardPayController@yearindex')->middleware('accessright:0,1,2,3,4,5');
    Route::any('categorySelect', 'CreditCardPayController@categorySelect')->middleware('accessright:0,1,2,3,4,5');
    Route::any('monthlywiseindex', 'CreditCardPayController@monthlywiseindex')->middleware('accessright:0,1,2,3,4,5');
});
...
Route::group(['prefix'=>'ExternalInvoice','middleware' => 'auth'], function() {
    ...
    Route::any('extinvoiceExceldownloadprocess', 'ExternalInvoiceController@extinvoiceExceldownloadprocess')->middleware('accessright:4');
    Route::any('extinvoicePdfdownloadprocess', 'ExternalInvoiceController@extinvoicePdfdownloadprocess')->middleware('accessright:4');
});
