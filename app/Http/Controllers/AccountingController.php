...
$year_month_day = $current_year . "-" . $account_close_mn . "-01";
       ...
       if($request->selYear=="") {
        ...
        //------
        $TotEstquery = Accounting::fnGetinvoiceTotalValue($request,$taxSearch,$date_month,$search_flg, $projecttype,$singlesearchtxt, $estimateno, $companyname, $startdate, $enddate,$fil);
        $get_view=array();
